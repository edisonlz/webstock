...
(function($) {
    function Plot(target_, data_, options_) {
            ...
            function plotPoints(data, radius, fill) {
				...
				for (var i = 0; i < data.length; ++i) {
                    ...
                    if (fill)
                        ctx.fill();
                    ctx.stroke();
					htm+='<b style="cursor:pointer;position:absolute;left:'+tHoz(x)+'px;top:'+tVert(y)+'px;width=10px height=10px" onclick="t_load('+data[i][3]+')"><font style="font-size:12px;color:#993333;">'+data[i][2]+'</font></b>';
                }
        ...
        function onClick(e) {
	       ...
	       {
       		  pos.y=def_data[0][parseInt(pos.x)][1]+"³É½»Á¿:"+def_data[0][parseInt(pos.x)][2];
