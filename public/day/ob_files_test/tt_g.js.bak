...
{
	$.get("http://chao.tl50.com:3001/stock/financial_loader?code="+code, function(data){
...
function stock_load_day()
{
	if(ttcode_show!=code)
	{
		$.get("http://chao.tl50.com:3001/stock/stock_day?code="+code, function(data){
...
{
	$("#commentText").load(decodeURI('http://chao.tl50.com:3001/stock/comment_read?code='+code));
}
...
function send_comment() { 
		...
		var url_c="http://chao.tl50.com:3001/stock/comment_add?name="+encodeURI($("#name").val())+"&code="+(code)+"&content="+encodeURI($("#comment_content").val());
