...
{
	$("#commentText").load(decodeURI('http://localhost:3001/stock/comment_read?code='+code));
}
...
function send_comment() { 
		...
		var url_c="http://localhost:3001/stock/comment_add?name="+encodeURI($("#name").val())+"&code="+(code)+"&content="+encodeURI($("#comment_content").val());
